...
namespace Chess_mono
{
    ...
    public class Game1 : Game
    {
        ...
        {           
            ...
            //Knight[0] = new Knight(Content.Load<Texture2D>("White knight"), new Rectangle(), true, true);
            //Queen[0] = new Queen(Content.Load<Texture2D>("White queen"), new Rectangle(), true, true);
